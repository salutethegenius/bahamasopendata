...
export default function GrandBahamaInstitutionalPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-4">
        <Link
          href="/grand-bahama"
          className="text-sm text-turquoise hover:underline inline-flex items-center gap-1"
        >
          ← Grand Bahama Digital Government Platform
        </Link>
      </div>
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">
          Institutional <span className="text-turquoise">Reference</span>
        </h1>
        <p className="text-gray-600 max-w-3xl">
          Ministry for Grand Bahama portfolio, the island&apos;s parliamentary
          delegation, and local-government districts — structured and citable public
          records that are not available as a digital roster elsewhere. First live
          module of the Grand Bahama Digital Government Platform.
        </p>
